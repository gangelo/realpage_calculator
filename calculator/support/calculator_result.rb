...
module RealPage
  module Calculator
    # Provides a container for the result returned from a Calculator
    # computation.
    class CalculatorResult
      ...
      # is encountered. In this case, #result would hold the offending input
      # token.
      #
      ...
      #
      # @param [Object] result the calculator's computed result or calculator
      # output. In the case of an error, it will contain the calculator's
      # initial input. An ArgumentError is raised if result is nil.
      #
      # @param [Hash] error the error encountered. This should be an error
      # found in RealPage::Calculator::Errors::Calculator.all_errors. An
      # ArgumentError is raised if error is not incuded in
      # RealPage::Calculator::Errors::Calculator.all_errors.
